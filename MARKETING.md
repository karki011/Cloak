# Cloak — Product Brief for Marketing
...
Cloak removes the gap between "I should know this" and "I do know this" — invisibly.
...
- Listening produces **no recording indicators** — Cloak taps system audio at a level that lights no purple dots (a genuine technical differentiator; most competitors can't avoid this)
...
- No account, no subscription to Cloak itself, no data sent anywhere except your chosen AI provider
...
- Cloak has **no servers, no accounts, no analytics**
...
- App icon: hooded figure with glowing eyes on indigo (`assets/cloak_1024.png`)

...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        hotkeys.register()
        NotificationCenter.default.addObserver(forName: .ghostOpenSettings, object: nil, queue: .main) { [weak self] _ in
            Task { @MainActor in self?.openSettings() }
        }
        NotificationCenter.default.addObserver(forName: .ghostOpenPermissions, object: nil, queue: .main) { [weak self] _ in
            Task { @MainActor in self?.openPermissions() }
        }
        NotificationCenter.default.addObserver(forName: .cloakOpenContext, object: nil, queue: .main) { [weak self] _ in
    ...
    func openPermissions() {
        ...
        window.title = "Cloak Permissions"
    ...
    func showOverlay() {
        ...
        NotificationCenter.default.post(name: .cloakFocusInput, object: nil)
    }
